...
<body>
    ...
    <nav class="navbar bg-dark text-light">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a href="admin-alluser.aspx" class="nav-link">
        ...
        <main class="p-5">
          ...
          <div>
            <div class="container shadow p-3 mb-5  rounded bg-body row">
              <div class="col-md">
                <div class="card p-3 shadow p-3 my-3 bg-dark rounded text-light" data-bs-toggle="tooltip" data-bs-placement="top" title="Users with Savings  Account">
                  
             <h2>Savings Accounts</h2>
                   <p class="lead"><asp:Label ID="saac" runat="server"></asp:Label></p>
                </div>
              </div>
              <div class="col-md">
                <div class="card p-3 shadow p-3  my-3 bg-dark rounded text-light" data-bs-toggle="tooltip" data-bs-placement="top" title="Users with Current Account">
                  <h2>Current Accounts</h2>
                    <p class="lead"><asp:Label ID="cuac" runat="server"></asp:Label></p> 
                </div>
              </div>
              <div class="col-md">
                <div class="card p-3 shadow p-3 my-3 bg-dark rounded text-light" data-bs-toggle="tooltip" data-bs-placement="top" title="Total Number  of Complaints">
                  <h2>Totals Accounts</h2> 
                    <p class="lead"><asp:Label ID="toac" runat="server"></asp:Label></p>
                </div>
              </div>
